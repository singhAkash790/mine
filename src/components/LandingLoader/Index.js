...
import { Logo } from "./Svg-compoent/Logo";
...
const Preloader = () => {
  ...
  return (
    ...
    >
      <div
        className="h-full flex-1 bg-[#f1f1f1] preloader-grid-item"
        ref={overlayRef}
      ></div>
      <div className="h-full flex-1 bg-[#f1f1f1] border-r border-l border-[#9b9b9b] preloader-grid-item"></div>
      <div className="h-full flex-1 bg-[#f1f1f1] preloader-grid-item"></div>
      <div className="absolute top-1/2 z-10 overflow-hidden -translate-y-1/2 h-200px w-fit  ">
        <div
          className="flex justify-center  items-center text-2xl opacity-0 w-[150px]"
          ref={logoRef}
        >
          <img
